...
let praixExtrait = "  349.99 MAD  ";
let praixNettoye = praixExtrait.trim();
let praixSansMAD = praixNettoye.replace ("MAD", "");
    praixNettoye = praixSansMAD.trim();
let praixNumber = Number (praixNettoye);
let praixTotal = praixNumber * 2;
console.log(praixTotal);